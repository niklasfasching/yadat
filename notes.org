* use
basic querying and stuff works - create an example component (?)
reagent would be nice for this - but is so much work to setup
then again...
what's the goal...
* ToDo
- spit/slurp in cljs, js - java is easy
