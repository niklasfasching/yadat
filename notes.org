-> more testing, rules
- validate default-src correct for nested clauses
...
* schema alteration
- datomic alters schema via transactions, attributes are in the db and datoms contain attribute id rather than attribute
